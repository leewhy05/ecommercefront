...
import vect from '../assets/Vector (10).png'
import vect1 from '../assets/Vector (12).png'
import vect2 from '../assets/Vector (13).png'
import vect4 from '../assets/Vector (14).png'
import vect5 from '../assets/image 10.png'
...
const Footer = () => {
  return (
    <div>
      ...
      <small style={{background:"gray",color:"white", fontFamily:"Open Sans"}}> &copy; LEEWHY</small>
    </div>
    </div>
  )
}
